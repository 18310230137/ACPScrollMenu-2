...
- (id)initACPItem:(UIImage *)backgroundImage iconImage:(UIImage *)iconImage andLabel:(NSString *)labelItem  {
	...
	if (self) {
        ...
        self.labelItem.textColor = [UIColor colorFromHexRGB:@"c9c9c9"];
        self.labelItem.font = [UIFont systemFontOfSize:14.0];
...
- (void)setHighlightedBackground:(ACPItem *)backgroundImageHightlighted iconHighlighted:(UIImage *)iconImageHighlighted textColorHighlighted:(UIColor *)texColorHighlighted {
	if (backgroundImageHightlighted) {
		self.bgImage.highlighted = backgroundImageHightlighted;
	}
